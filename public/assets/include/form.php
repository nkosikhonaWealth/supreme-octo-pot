...
$fromemail = array(
	'email' => 'noreply@iyly.bizgrowsz.online', // Company's Email Address (preferably currently used Domain Name)
	'name' => 'Insika Yelikusasa Lensha Yeswatini' // Company Name
);
...
$mail->isSMTP();
$mail->Host       = 'premium180.web-hosting.com'; // SMTP Host
$mail->SMTPAuth   = true;
$mail->Username   = 'noreply@iyly.bizgrowsz.online'; // SMTP Username
$mail->Password   = 'Khona@2025'; // SMTP Password
